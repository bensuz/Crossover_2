    ...
    <div className="flex gap-10 h-[790px] max-w-[1240px] py-10 mx-auto bg-[#ffe2a0]">
        ...
        <div className=" relative h-[395px] bg-white">
          <div className="flex flex-col m-10 p-4 bg-white shadow-[0_15px_20px_rgba(217,149,0,0.2)] text-center absolute bottom-0">
            ...
            <div className="flex flex-col p-4">
              ...
              <span className="price text-center pb-4">1020$</span>
      ...
      <div className="w-3/4 bg-white bg-[url('components/section2/assets/P.svg')] bg-cover bg-no-repeat">
        <div className="py-10">
          ...
          <h2 className="title text-center">Enjoy delicious dishes</h2>
        </div>
        <div>
          ...
          <div className="flex gap-4">
            <div className="flex w-1/2">
              ...
              <div className="flex flex-col gap-2">
                <span className="title pt-4">Spaghetti Bolognese</span>
                <span>
                  Ground beef , onions, celery, carrot, tomato paste, fresh bay
                  leaves, oregano
                </span>
                <span>300g</span>
              </div>
        ...
        <div className="flex justify-center relative">
          ...
          <span className="absolute top-[10px]">&#x003C; 3/9 &#x003E;</span>
        </div>
      </div>
    </div>
  );
