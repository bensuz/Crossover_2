                ...
                <div className="flex-col absolute right-[2rem] bg-white w-[500px] h-[550px] text-center items-center border-8 border-[#fff4e1] opacity-90 top-[-5rem]">
                    <div className="flex-col  w-[100%] ">
                        ...
                        <p className="font-[Roboto] font-[400] w-[100%] pl-[2rem]  pr-[2rem] ">
                            Highly spacious two-bedroom suite with a relaxing
                            seating area. Featuring piano, a dining area and a
                            complete, filly equipped kitchen
                        </p>
